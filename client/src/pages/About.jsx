...
const About = () => {
  ...
  useEffect(() => {
    ...
    scriptElement.src = "/src/js/about.js";
                  ...
                  <div className="feature-left text-center">
                    ...
                    <div className="feature-copy feature-copy4">
                      ...
                      <p id="feature4">
                        ...
                        searched word using{" "}
                        <a className='link' target="_blank" href="https://www.npmjs.com/package/elevenlabs-node">
                          Elevenlabs tts Api</a>
